            ...
            <div className="container flex h-16 items-center justify-between">
                ...
                <Link href="/" className="group flex items-center space-x-3">
                    <div className="relative h-12 w-12 overflow-hidden rounded-full border-2 border-primary/20 shadow-sm group-hover:border-primary transition-colors">
                        <Image src={logoUrl} alt="Momcakespe Logo" fill className="object-cover" />
                    </div>
                    <span className="text-xl font-serif font-bold text-primary tracking-wide group-hover:text-primary transition-colors">Momcakespe</span>
                </Link>
